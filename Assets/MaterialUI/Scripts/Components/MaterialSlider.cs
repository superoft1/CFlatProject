    ...
    public float Coef
    {
      ...
      set
      {
        ...
        public void OnSliderValueChanged(float value)
        {
            ...
            m_PopupText.text = (slider.value * m_Coef).ToString("#0.#");

            if (m_ValueText != null)
            {
                m_ValueText.text = (slider.value * m_Coef).ToString("#0.##") + (string.IsNullOrEmpty(m_ValueTextSuffix) ? "" : m_ValueTextSuffix);
            }
