...
{
  public class RestrictorPlateBodyCreator : BodyCreator<RestrictorPlate, Body>
  {
    public RestrictorPlateBodyCreator( Entity _entity ) : base( _entity )
    {}

    protected override void SetupGeometry( Body body, RestrictorPlate entity )
    {
