...
{
  public class InstrumentBodyCreator : BodyCreator<Instrument, Body>
  {
    public InstrumentBodyCreator( Entity _entity ) : base( _entity )
    {}

    protected override void SetupGeometry( Body body, Instrument entity )
    {
