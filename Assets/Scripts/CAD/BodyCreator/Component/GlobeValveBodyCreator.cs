...
{
  public class GlobeValveBodyCreator : BodyCreator<GlobeValve, Body>
  {
    public GlobeValveBodyCreator( Entity _entity ) : base( _entity )
    {}

    protected override void SetupGeometry( Body body, GlobeValve valve )
    {
