...
{
  [Entity( EntityType.Type.OpenSpectacleBlank )]
  public class OpenSpectacleBlank : Component, ILinearComponent
  {
    ...
    public OpenSpectacleBlank( Document document ) : base( document )
    {
      _length = new Memento<double>( this ) ;

      ComponentName = "OpenSpectacleBlank" ;
    }
    ...
    public override void CopyFrom( ICopyable another, CopyObjectStorage storage )
    {
      ...
      var entity = another as OpenSpectacleBlank;
