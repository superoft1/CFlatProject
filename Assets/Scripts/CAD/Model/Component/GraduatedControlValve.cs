...
namespace Chiyoda.CAD.Model
{
  ...
  public class GraduatedControlValve : Component, ILinearComponent
  {
    ...
    public GraduatedControlValve( Document document ) : base( document )
    {
      _length = CreateMementoAndSetupValueEvents( 0.0 ) ;

      ComponentName = "GraduatedControlValve" ;
    }
    ...
    public override void CopyFrom( ICopyable another, CopyObjectStorage storage )
    {
      ...
      var entity = another as GraduatedControlValve;
