...
{
  [Entity( EntityType.Type.SlipOnFlange )]
  public class SlipOnFlange : Component, ILinearComponent
  {
    ...
    public SlipOnFlange( Document document ) : base( document )
    {
      _length = new Memento<double>( this ) ;

      ComponentName = "SlipOnFlange" ;
    }
    ...
    public override void CopyFrom( ICopyable another, CopyObjectStorage storage )
    {
      ...
      var entity = another as SlipOnFlange;
