...
{
  [Entity( EntityType.Type.GlobeValve )]
  public class GlobeValve : Component, ILinearComponent
  {
    ...
    public GlobeValve( Document document ) : base( document )
    {
      _length = new Memento<double>( this ) ;

      ComponentName = "GlobeValve" ;
    }
    ...
    public override void CopyFrom( ICopyable another, CopyObjectStorage storage )
    {
      ...
      var entity = another as GlobeValve;
