...
{
  [Entity( EntityType.Type.RestrictorPlate )]
  public class RestrictorPlate : Component, ILinearComponent
  {
    ...
    public RestrictorPlate( Document document ) : base( document )
    {
      _length = CreateMementoAndSetupValueEvents( 0.0 ) ;

      ComponentName = "RestrictorPlate" ;
    }
    ...
    public override void CopyFrom( ICopyable another, CopyObjectStorage storage )
    {
      ...
      var entity = another as RestrictorPlate;
