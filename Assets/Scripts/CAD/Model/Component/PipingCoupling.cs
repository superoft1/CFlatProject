...
{
  [Entity( EntityType.Type.PipingCoupling )]
  public class PipingCoupling : Component, ILinearComponent
  {
    ...
    public PipingCoupling( Document document ) : base( document )
    {
      _length = new Memento<double>( this ) ;

      ComponentName = "Coupling" ;
    }
    ...
    public override void CopyFrom( ICopyable another, CopyObjectStorage storage )
    {
      ...
      var entity = another as PipingCoupling;
