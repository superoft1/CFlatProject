...
{
  [Entity( EntityType.Type.Instrument )]
  public class Instrument : Component, ILinearComponent
  {
    ...
    public Instrument( Document document ) : base( document )
    {
    ...
    public override void CopyFrom( ICopyable another, CopyObjectStorage storage )
    {
      ...
      var entity = another as Instrument;
