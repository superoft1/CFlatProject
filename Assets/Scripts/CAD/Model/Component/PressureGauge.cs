...
{
  [Entity( EntityType.Type.PressureGauge )]
  public class PressureGauge : Component, ILinearComponent
  {
    ...
    public PressureGauge( Document document ) : base( document )
    {
      _length = CreateMementoAndSetupValueEvents( 0.0 ) ;

      ComponentName = "PressureGauge" ;
    }
    ...
    public override void CopyFrom( ICopyable another, CopyObjectStorage storage )
    {
      ...
      var entity = another as PressureGauge;
