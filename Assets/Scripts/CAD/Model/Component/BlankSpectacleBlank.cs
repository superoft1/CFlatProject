...
{
  [Entity( EntityType.Type.BlankSpectacleBlank )]
  public class BlankSpectacleBlank : Component, ILinearComponent
  {
    ...
    public BlankSpectacleBlank( Document document ) : base( document )
    {
      _length = new Memento<double>(this);

      ComponentName = "BlankSpectacleBlank";
    }
    ...
    public override void CopyFrom( ICopyable another, CopyObjectStorage storage )
    {
      ...
      var entity = another as BlankSpectacleBlank;
