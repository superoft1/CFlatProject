...
{
    [Entity(EntityType.Type.ConnectPositionOnPlane)]
    public class ConnectPositionOnPlane : ConnectPosition
    {
        ...
        public ConnectPositionOnPlane( Document document ) : base( document )
        {
        ...
        public override void CopyFrom( ICopyable another, CopyObjectStorage storage )
        {
            ...
            var entity = another as ConnectPositionOnPlane;
