...
public class XMLBlindFlangeImporter : XMLEntityImporter {

  public XMLBlindFlangeImporter(EntityType.Type _type, System.Xml.XmlElement _element) : base(_type, _element)
  {
  }
