...
public class XMLButterflyValveImpoter : XMLEntityImporter {

  public XMLButterflyValveImpoter(EntityType.Type _type, System.Xml.XmlElement _element) : base(_type, _element)
  {
  }
  ...
  public override Entity Import(Chiyoda.CAD.Core.Document doc)
  {
    ...
    var butterflyValve = entity as ButterflyValve;
