...
public class XMLPipingElbow90Importer : XMLEntityImporter {

  public XMLPipingElbow90Importer(EntityType.Type _type, System.Xml.XmlElement _element) : base(_type, _element)
  {
  }
  ...
  public override Entity Import(Chiyoda.CAD.Core.Document doc)
  {
    ...
    Diameter diameter = DiameterFactory.Default();
    ...
    LeafEdgeCodSysUtils.LocalizeElbow90Component(ParentLeafEdge, origin, axis, reference);

    elbow.ChangeSizeNpsMm( 0, diameter.NpsMm ) ;
    elbow.SetElbowTypeFromBendLength( diameter, ParentLeafEdge.GlobalCod.LocalizePoint( term1 ).magnitude ) ;
