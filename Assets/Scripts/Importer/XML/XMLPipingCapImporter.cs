...
public class XMLPipingCapImporter : XMLEntityImporter {

  public XMLPipingCapImporter(EntityType.Type _type, System.Xml.XmlElement _element) : base(_type, _element)
  {
  }
