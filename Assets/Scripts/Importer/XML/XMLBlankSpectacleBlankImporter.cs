...
public class XMLBlankSpectacleBlankImporter : XMLEntityImporter
{

  public XMLBlankSpectacleBlankImporter(EntityType.Type _type, System.Xml.XmlElement _element) : base(_type, _element)
  {
  }
  ...
  public override Entity Import(Chiyoda.CAD.Core.Document doc)
  {
    ...
    var blank = entity as BlankSpectacleBlank;
