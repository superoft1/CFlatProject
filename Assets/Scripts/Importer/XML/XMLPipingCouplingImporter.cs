...
public class XMLPipingCouplingImporter : XMLEntityImporter {

  public XMLPipingCouplingImporter(EntityType.Type _type, System.Xml.XmlElement _element):base(_type, _element)
  {    
  }
  ...
  public override Entity Import(Chiyoda.CAD.Core.Document doc)
  {
    ...
    var pipingCoupling = entity as PipingCoupling;
    ...
    pipingCoupling.Diameter = diameter;
    pipingCoupling.Length = (term2 - term1).magnitude;
    return pipingCoupling;
  }
