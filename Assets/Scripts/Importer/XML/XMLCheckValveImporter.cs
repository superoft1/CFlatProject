...
public class XMLCheckValveImporter : XMLEntityImporter {

  public XMLCheckValveImporter(EntityType.Type _type, System.Xml.XmlElement _element) : base(_type, _element)
  {
  }
  ...
  public override Entity Import(Chiyoda.CAD.Core.Document doc)
  {
    ...
    var valve = entity as CheckValve;
