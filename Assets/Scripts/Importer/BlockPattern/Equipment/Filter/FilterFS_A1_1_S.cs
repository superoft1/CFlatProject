...
{
  public class FilterFS_A1_1_S : FilterBase<BlockPatternArray>
  {

    public FilterFS_A1_1_S( Document doc ) : base( doc, "FS-A1-1-S" )
    {
      Info = new SingleFilterPatternInfo
      {
        ...
        SuctionFlexHelper = new int[ , ] { { 1, 1 }, { 10, 10 }, { 11, 16 }, { 7, 8 } },
