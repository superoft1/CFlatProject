...
namespace Importer.BlockPattern.Equipment.TopTopTypePump.TT_B1_S_S_N
{
  public class TopTopTypePumpTT_B1_S_S_N : TopTopTypePumpBase<BlockPatternArray>
  {
    public TopTopTypePumpTT_B1_S_S_N ( Document doc ) : base( doc, "TT-B1-S-S-N")
    {
      Info = new SingleBlockPatternIndexInfo
      {
        ...
        DischargePipeIndexRange = new int[,]{ { 1,39 }, },
