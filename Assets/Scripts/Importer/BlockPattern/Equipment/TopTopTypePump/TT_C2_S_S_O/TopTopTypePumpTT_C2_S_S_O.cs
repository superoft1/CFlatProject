...
namespace Importer.BlockPattern.Equipment.TopTopTypePump.TT_C2_S_S_O
{
  public class TopTopTypePumpTT_C2_S_S_O : TopTopTypePumpBase<BlockPatternArray>
  {
    TopTopTypeMinimumFlowPipeLengthUpdater _lengthUpdater;
    TopTopTypePumpPipeIndicesKeeper _keeper;

    public TopTopTypePumpTT_C2_S_S_O( Document doc ) : base( doc, "TT-C2-S-S-O")
    {
      Info = new SingleBlockPatternIndexInfoWithMinimumFlow
      {
        ...
        {
          { SingleBlockPatternIndexInfo.SuctionIndexType.SuctionNozzleFlange, 49 },
          { SingleBlockPatternIndexInfo.SuctionIndexType.SuctionNozzle, 48 },
          { SingleBlockPatternIndexInfo.SuctionIndexType.SuctionNozzleReducer, 47 },
          ...
          { SingleBlockPatternIndexInfo.SuctionIndexType.SuctionSystemFlexStop,  45 },
          { SingleBlockPatternIndexInfo.SuctionIndexType.SuctionSystemFlexOrigin, 46 },
        },
       MinimumFlowIndexTypeValue = new Dictionary<SingleBlockPatternIndexInfoWithMinimumFlow.MinimumFlowIndexType, int>
        ...
        SuctionFlexHelper = new int[,]{ { 2, 45 }, },
        DischargeFlexHelper = new int[,]{ { 63, 35  },{ 4, 9 },{ 1, 1 } },
        SuctionPipeIndexRange = new int[,]{ { 0, 48  }, },
    ...
    public Chiyoda.CAD.Topology.BlockPattern Create( Action<Edge> onFinish )
    {
      ...
      bpa.SetVertexName( "MinimumFlowEnd", "N-3", HalfVertex.FlowType.FromThisToAnother ) ;
    ...
    internal override void SetPropertyAndRule( SingleBlockPatternIndexInfo info )
    {
      ...
      if (info is SingleBlockPatternIndexInfoWithMinimumFlow infoDerived) {
        ...
        rule = BaseBp.RuleList.AddRule(".MFSD_Offset",
          "#NextOfMinimumFlowStageBOPSpacer.MaxX-#MinimumFlowAdjustingStart.MinX");
