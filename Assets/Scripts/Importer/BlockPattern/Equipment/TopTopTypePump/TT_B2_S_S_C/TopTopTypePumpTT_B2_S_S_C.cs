...
namespace Importer.BlockPattern.Equipment.TopTopTypePump.TT_B2_S_S_C
{
  public class TopTopTypePumpTT_B2_S_S_C : TopTopTypePumpBase<BlockPatternArray>
  {

    TopTopTypePumpSystemLengthUpdater _systemLength;
    TopTopTypePumpPipeIndicesKeeper _keeper;

    public TopTopTypePumpTT_B2_S_S_C(Document doc) : base(doc, "TT-B2-S-S-C")
    {
      Info = new SingleBlockPatternIndexInfoWithMinimumFlow {
        ...
        SuctionIndexTypeValue = new Dictionary<SingleBlockPatternIndexInfo.SuctionIndexType, int>
        {
          ...
          { SingleBlockPatternIndexInfo.SuctionIndexType.SuctionSystemFlexOrigin, 35 },
        ...
        DischargePipeIndexRange = new int[,] { { 1, 26 }, { 38, 50 } },     //  set pipes not to set pre-post oriflow pipes
