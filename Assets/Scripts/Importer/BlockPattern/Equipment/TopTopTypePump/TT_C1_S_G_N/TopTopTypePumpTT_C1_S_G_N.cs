...
namespace Importer.BlockPattern.Equipment.TopTopTypePump.TT_C1_S_G_N
{
  public class TopTopTypePumpTT_C1_S_G_N : TopTopTypePumpBase<BlockPatternArray>
  {
    public TopTopTypePumpTT_C1_S_G_N( Document doc ) : base( doc, "TT-C1-S-G-N")
    {
      Info = new SingleBlockPatternIndexInfo
      {
        ...
        SuctionIndexTypeValue = new Dictionary<SingleBlockPatternIndexInfo.SuctionIndexType, int>
        {
          ...
          { SingleBlockPatternIndexInfo.SuctionIndexType.SuctionSystemFlexOrigin, 43 }, //  suction origin (reducer)
        },
