...
namespace Importer.BlockPattern.Equipment.TopTopTypePump
{
  ...
  class TopTopTypePumpPipeLengthUpdater
  {
    ...
    private TopTopTypePumpPipeLengthUpdater(CompositeBlockPattern bpa, Chiyoda.CAD.Topology.BlockPattern bp, SingleBlockPatternIndexInfo info)
    {
      BpOwner = bpa;
      BaseBp = bp;
      Info = info;
    ...
    public static TopTopTypePumpPipeLengthUpdater Create(CompositeBlockPattern bpa, Chiyoda.CAD.Topology.BlockPattern bp, SingleBlockPatternIndexInfo info)
    {
      TopTopTypePumpPipeLengthUpdater instance = new TopTopTypePumpPipeLengthUpdater(bpa,bp,info);
      return instance;
    }
    ...
    public void KeepDischargePipeOrderForLaterAdjustment()
    {
      ...
      LeafEdge[] edges = TopTopTypePumpGroupLeafEdgeExtractor.ExtractLeafEdgeArrayFromGroupHierarachy(dischargeGroup);
      int[] order;
    ...
    public void AdjustDischargePipeIndexesAfterReconstructingGroups(){
      ...
      Dictionary<LeafEdge, int> edges = TopTopTypePumpGroupLeafEdgeExtractor.ExtractLeafEdgeDictionaryFromGroupHierarachy(dischargeGroup);
    ...
    private static void AssortDischargeMinimumLengths(Chiyoda.CAD.Topology.BlockPattern bp, SingleBlockPatternIndexInfo info)
    {
      ...
      LeafEdge [] leArray = TopTopTypePumpGroupLeafEdgeExtractor.ExtractLeafEdgeArrayFromGroupHierarachy(dischargeGroup);
