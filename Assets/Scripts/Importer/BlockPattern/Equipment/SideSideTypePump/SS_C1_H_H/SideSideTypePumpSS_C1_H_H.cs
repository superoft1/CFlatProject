...
namespace Importer.BlockPattern.Equipment.SideSideTypePump.SS_C1_H_H
{
  public class SideSideTypePumpSS_C1_H_H : SideSideTypePumpBase<BlockPatternArray>
  {
    public SideSideTypePumpSS_C1_H_H( Document doc ) : base( doc, "SS-C1-H-H" )
    {
      Info = new SingleBlockPatternIndexInfo
      {
        ...
        {
          { SingleBlockPatternIndexInfo.DischargeIndexType.DischargeBOP, 40 },
        ...
        SuctionIndexTypeValue = new Dictionary<SingleBlockPatternIndexInfo.SuctionIndexType, int>
        {
          ...
          { SingleBlockPatternIndexInfo.SuctionIndexType.SuctionSystemFlexStop,   33 },   //  Flex 連動の停止 Edge（これよりPump側は影響を受けない）
          { SingleBlockPatternIndexInfo.SuctionIndexType.SuctionSystemFlexOrigin, 34 },   //  Flex を連動させるSuction 系のStopの一つPump側のLeafEdge
        },
