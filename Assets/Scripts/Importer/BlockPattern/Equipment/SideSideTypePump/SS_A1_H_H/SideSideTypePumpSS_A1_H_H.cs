...
namespace Importer.BlockPattern.Equipment.SideSideTypePump.SS_A1_H_H
{
  public class SideSideTypePumpSS_A1_H_H : SideSideTypePumpBase<BlockPatternArray>
  {
    public SideSideTypePumpSS_A1_H_H( Document doc ) : base( doc, "SS-A1-H-H" )
    {
      Info = new SingleBlockPatternIndexInfo
      {
        ...
        DischargeFlexHelper = new int[,]{ { 10, 31 }, },
