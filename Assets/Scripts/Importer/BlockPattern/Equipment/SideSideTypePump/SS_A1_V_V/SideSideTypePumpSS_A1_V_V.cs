...
namespace Importer.BlockPattern.Equipment.SideSideTypePump.SS_A1_V_V
{
  public class SideSideTypePumpSS_A1_V_V : SideSideTypePumpBase<BlockPatternArray>
  {
    public SideSideTypePumpSS_A1_V_V(Document doc) : base(doc, "SS-A1-V-V")
    {
      Info = new SingleBlockPatternIndexInfo
      {
        ...
        DischargeIndexTypeValue = new Dictionary<SingleBlockPatternIndexInfo.DischargeIndexType, int>
        {
          ...
          { SingleBlockPatternIndexInfo.DischargeIndexType.DischargeEnd, 29 },
          { SingleBlockPatternIndexInfo.DischargeIndexType.DischargeNozzle, 1 },
          { SingleBlockPatternIndexInfo.DischargeIndexType.DischargeSystemFlexStart,  22 },  //  Flex 連動の開始 Edge（これよりPump側が影響を受ける）
        ...
        {
          { SingleBlockPatternIndexInfo.NextOfIndexType.NextOfDischargeEnd, 28 },
          { SingleBlockPatternIndexInfo.NextOfIndexType.NextOfSuctionEnd, 1 },
        },

        SuctionFlexHelper = new int[,]{ { 2, 21 }, },
        DischargeFlexHelper = new int[,]{ { 10, 22 }, },
        SuctionPipeIndexRange = new int[,]{ { 0, 30 }, },
        DischargePipeIndexRange = new int[,]{ { 1, 29 }, },
