...
namespace Importer.BlockPattern.Equipment.SideSideTypePump.SS_C1_V_V
{
  public class SideSideTypePumpSS_C1_V_V : SideSideTypePumpBase<BlockPatternArray>
  {
    public SideSideTypePumpSS_C1_V_V ( Document doc ) : base( doc, "SS-C1-V-V")
    {
      Info = new SingleBlockPatternIndexInfo
      {
        ...
        {
          { SingleBlockPatternIndexInfo.DischargeIndexType.DischargeBOP, 31 },
        ...
        SuctionIndexTypeValue = new Dictionary<SingleBlockPatternIndexInfo.SuctionIndexType, int>
        {
          ...
          { SingleBlockPatternIndexInfo.SuctionIndexType.SuctionSystemFlexStart,   6 },   //  Flex 連動の開始 Edge（これよりPump側が影響を受ける）
          { SingleBlockPatternIndexInfo.SuctionIndexType.SuctionSystemFlexStop,   29 },   //  Flex 連動の停止 Edge（これよりPump側は影響を受けない）
          { SingleBlockPatternIndexInfo.SuctionIndexType.SuctionSystemFlexOrigin, 30 },   //  Flex を連動させるSuction 系のStopの一つPump側のLeafEdge
        },
        ...
        SuctionFlexHelper = new int[,]{ { 6,29  }, },
        DischargeFlexHelper = new int[,]{ { 31,10  }, },
        SuctionPipeIndexRange = new int[,]{ { 0,38  }, },
