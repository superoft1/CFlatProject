...
namespace Importer.BlockPattern.Equipment.EndTopTypePump.ET_C2_H_H_L
{
  public class EndTopTypePumpET_C2_H_H_L : EndTopTypePumpBase<BlockPatternArray>
  {
    EndTopTypePumpPipeIndexKeeper _keeper;

    public EndTopTypePumpET_C2_H_H_L(Document doc ) : base( doc, "ET-C2-H-H-L")
    {
      Info = new SingleBlockPatternIndexInfoWithMinimumFlow
      {
        ...
        {
          { SingleBlockPatternIndexInfo.SuctionIndexType.SuctionNozzle, 38 },
          ...
          { SingleBlockPatternIndexInfo.SuctionIndexType.SuctionSystemFlexStop,   36 },
          { SingleBlockPatternIndexInfo.SuctionIndexType.SuctionSystemFlexOrigin, 37 }, //  suction origin (reducer)
        },
        MinimumFlowIndexTypeValue = new Dictionary<SingleBlockPatternIndexInfoWithMinimumFlow.MinimumFlowIndexType, int>
        {
          { SingleBlockPatternIndexInfoWithMinimumFlow.MinimumFlowIndexType.NextOfMinimumFlowEnd, 33 },
          { SingleBlockPatternIndexInfoWithMinimumFlow.MinimumFlowIndexType.MinimumFlowEnd, 34 },
          { SingleBlockPatternIndexInfoWithMinimumFlow.MinimumFlowIndexType.MinimumFlowHeaderBOPSpacer, 32 },
          { SingleBlockPatternIndexInfoWithMinimumFlow.MinimumFlowIndexType.NextOfMinimumFlowHeaderBOPSpacer, 31 },
        ...
        //SuctionFlexHelper = new int[,]{ { 2, 18 },{ 22, 36 }, },  //  Pipe no.20 is in between two flanges with no length.
    ...
    internal override void SetPropertyAndRule( SingleBlockPatternIndexInfo info )
    {
      ...
      BaseBp.RegisterUserDefinedProperty( "AccessSpace", PropertyType.Length, 5.9 ) ;
