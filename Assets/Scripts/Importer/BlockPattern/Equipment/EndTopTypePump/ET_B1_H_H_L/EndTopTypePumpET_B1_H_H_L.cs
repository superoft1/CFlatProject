...
namespace Importer.BlockPattern.Equipment.EndTopTypePump.ET_B1_H_H_L
{
  public class EndTopTypePumpET_B1_H_H_L : EndTopTypePumpBase<BlockPatternArray>
  {
    public EndTopTypePumpET_B1_H_H_L( Document doc ) : base( doc, "ET-B1-H-H-L")
    {
      Info = new SingleBlockPatternIndexInfo
      {
        ...
        SuctionIndex = 1,
        BasePumpIndex = 0,
        DischargeAngleGroupIndexList = Enumerable.Range( 3, 8 ).ToList(),  //  the second argument is not an index 
        ...
        DischargeFlexIndexList = new List<int> { /*1*/ },
        SuctionFlexIndexList = new List<int> { /*2*/ },
