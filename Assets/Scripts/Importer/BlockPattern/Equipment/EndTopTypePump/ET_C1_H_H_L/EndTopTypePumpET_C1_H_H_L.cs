...
namespace Importer.BlockPattern.Equipment.EndTopTypePump.ET_C1_H_H_L
{
  public class EndTopTypePumpET_C1_H_H_L : EndTopTypePumpBase<BlockPatternArray>
  {
    public EndTopTypePumpET_C1_H_H_L( Document doc ) : base( doc, "ET-C1-H-H-L")
    {
      Info = new SingleBlockPatternIndexInfo
      {
        ...
        {
          { SingleBlockPatternIndexInfo.SuctionIndexType.SuctionNozzle, 35 },
          ...
          { SingleBlockPatternIndexInfo.SuctionIndexType.SuctionSystemFlexStop,   33 },
          { SingleBlockPatternIndexInfo.SuctionIndexType.SuctionSystemFlexOrigin, 34 }, //  suction origin (reducer)
        },
        ...
        SuctionPipeIndexRange = new int[,]{ { 0,35  }, },
