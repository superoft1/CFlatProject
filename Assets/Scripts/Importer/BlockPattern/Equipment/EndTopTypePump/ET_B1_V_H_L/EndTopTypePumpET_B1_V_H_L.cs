...
namespace Importer.BlockPattern.Equipment.EndTopTypePump.ET_B1_V_H_L
{
  public class EndTopTypePumpET_B1_V_H_L : EndTopTypePumpBase<BlockPatternArray>
  {
    public EndTopTypePumpET_B1_V_H_L( Document doc ) : base( doc, "ET-B1-V-H-L" )
    {
    ...
    {
      BaseBp.RegisterUserDefinedProperty( "AccessSpace", PropertyType.Length, 1.9 ) ;
      {
        var bpa = BpOwner ;
