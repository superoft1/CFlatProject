...
namespace Importer.BlockPattern.Equipment.EndTopTypePump.ET_C1_V_V_L
{
  public class EndTopTypePumpET_C1_V_V_L : EndTopTypePumpBase<BlockPatternArray>
  {
    public EndTopTypePumpET_C1_V_V_L( Document doc ) : base( doc, "ET-C1-V-V-L")
    {
      Info = new SingleBlockPatternIndexInfo
      {
        ...
        {
          { SingleBlockPatternIndexInfo.SuctionIndexType.SuctionNozzle, 31 },
          { SingleBlockPatternIndexInfo.SuctionIndexType.SuctionEnd, 0 },
          { SingleBlockPatternIndexInfo.SuctionIndexType.SuctionSystemFlexStart,  6 },
          { SingleBlockPatternIndexInfo.SuctionIndexType.SuctionSystemFlexStop,   29 },
          { SingleBlockPatternIndexInfo.SuctionIndexType.SuctionSystemFlexOrigin, 30 }, //  suction origin (reducer)
        },
        ...
        SuctionPipeIndexRange = new int[,]{ { 0,31  }, },
        DischargePipeIndexRange = new int[,]{ { 1,36 }, },
