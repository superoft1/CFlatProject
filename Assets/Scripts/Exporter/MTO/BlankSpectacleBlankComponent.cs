...
namespace MTO
{
  public class BlankSpectacleBlankComponent : AxisymmetricComponent
  {
    private readonly BlankSpectacleBlank _blank;

    public BlankSpectacleBlankComponent( BlankSpectacleBlank blank )
    {
      _blank = blank;
    }
